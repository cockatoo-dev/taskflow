  ...
  <StdContainer>
    <main class=" text-slate-800 dark:text-slate-200">
      <div class="py-16 text-center">
        <h1 v-if="error.status === 404" class="pb-2 text-xl text-center font-bold">Page not found.</h1>
        <h1 v-else-if="error.status && error.status >= 500" class="pb-2 text-xl text-center font-bold">Something went wrong on our end.</h1>
